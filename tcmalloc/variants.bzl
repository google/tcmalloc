...
build_variants = [
    ...
    {
        "name": "8k_reuse_size_classes_v2",
        "malloc": "//tcmalloc",
        "deps": ["//tcmalloc:common_8k_pages"],
        "env": {"BORG_EXPERIMENTS": "TEST_ONLY_TCMALLOC_REUSE_SIZE_CLASSES_V2"},
    },
    {
        "name": "32k_reuse_size_classes_v2",
    ...
    {
        "name": "256k_reuse_size_classes_v2",
    ...
    {
        "name": "small_but_slow_reuse_size_classes_v2",
