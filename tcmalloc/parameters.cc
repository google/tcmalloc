...
ABSL_CONST_INIT std::atomic<bool> Parameters::madvise_sampled_allocations_(
    false);
...
bool TCMalloc_Internal_GetMadviseSampledAllocations() {
  return Parameters::madvise_sampled_allocations();
}

void TCMalloc_Internal_SetMadviseSampledAllocations(bool v) {
...
void TCMalloc_Internal_SetEventTraceMemoryLimit(int64_t v) {
