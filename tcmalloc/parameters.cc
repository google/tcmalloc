...
ABSL_CONST_INIT std::atomic<bool>
    Parameters::release_max_sampled_or_cold_pages_(true);
...
bool TCMalloc_Internal_GetReleaseMaxColdPages() {
  return Parameters::release_max_sampled_or_cold_pages();
}

void TCMalloc_Internal_SetReleaseMaxColdPages(bool v) {
  Parameters::release_max_sampled_or_cold_pages_.store(
      v, std::memory_order_relaxed);
}
