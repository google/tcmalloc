...
#if ABSL_HAVE_ATTRIBUTE(malloc_span)
#define TCMALLOC_ATTRIBUTE_MALLOC_SPAN __attribute__((malloc_span))
#else
#define TCMALLOC_ATTRIBUTE_MALLOC_SPAN
#endif
...
[[nodiscard]] __sized_ptr_t __size_returning_new(size_t size)
    TCMALLOC_ATTRIBUTE_MALLOC_SPAN;
[[nodiscard]] __sized_ptr_t __size_returning_new_hot_cold(size_t, __hot_cold_t)
    TCMALLOC_ATTRIBUTE_MALLOC_SPAN;
[[nodiscard]] __sized_ptr_t __size_returning_new_aligned(
    size_t, std::align_val_t) TCMALLOC_ATTRIBUTE_MALLOC_SPAN;
