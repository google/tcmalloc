...
TEST(PageAllocInfo, Small) {
  ...
  info.RecordAlloc(0, 2);
  info.RecordAlloc(0, 2);
  info.RecordAlloc(0, 2);

  info.RecordAlloc(0, 3);
  info.RecordAlloc(0, 3);
