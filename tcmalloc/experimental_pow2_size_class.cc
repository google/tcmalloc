...
//  bytes pages batch   class  objs |fixed sampling|    inc
  ...
  {     8,    1,   32},  //  1  1024  0.58%    0.42%   0.00%
  {    16,    1,   32},  //  2   512  0.58%    0.42% 100.00%
  {    32,    1,   32},  //  3   256  0.58%    0.42% 100.00%
  {    64,    1,   32},  //  4   128  0.58%    0.42% 100.00%
  {   128,    1,   32},  //  5    64  0.58%    0.42% 100.00%
  {   256,    1,   32},  //  6    32  0.58%    0.42% 100.00%
  {   512,    1,   32},  //  7    16  0.58%    0.42% 100.00%
  {  1024,    1,   32},  //  8     8  0.58%    0.42% 100.00%
  {  2048,    2,   32},  //  9     8  0.29%    0.42% 100.00%
  {  4096,    1,   16},  // 10     2  0.58%    0.43% 100.00%
  {  8192,    1,    8},  // 11     1  0.58%    0.03% 100.00%
  { 16384,    2,    4},  // 12     1  0.29%    0.03% 100.00%
  { 32768,    4,    2},  // 13     1  0.15%    0.03% 100.00%
  { 65536,    8,    2},  // 14     1  0.07%    0.03% 100.00%
  {131072,   16,    2},  // 15     1  0.04%    0.03% 100.00%
...
//  bytes pages batch   class  objs |fixed sampling|    inc
  {     0,    0,    0},  //  0     0  0.00%    0.00%   0.00%
  {     8,    1,   32},  //  1  4096  0.15%    1.60%   0.00%
  {    16,    1,   32},  //  2  2048  0.15%    1.60% 100.00%
  {    32,    1,   32},  //  3  1024  0.15%    1.60% 100.00%
  {    64,    1,   32},  //  4   512  0.15%    1.60% 100.00%
  {   128,    1,   32},  //  5   256  0.15%    1.60% 100.00%
  {   256,    1,   32},  //  6   128  0.15%    1.60% 100.00%
  {   512,    1,   32},  //  7    64  0.15%    1.60% 100.00%
  {  1024,    1,   32},  //  8    32  0.15%    1.60% 100.00%
  {  2048,    1,   32},  //  9    16  0.15%    1.60% 100.00%
  {  4096,    1,   16},  // 10     8  0.15%    1.60% 100.00%
  {  8192,    1,    8},  // 11     4  0.15%    1.60% 100.00%
  { 16384,    1,    4},  // 12     2  0.15%    1.60% 100.00%
  { 32768,    1,    2},  // 13     1  0.15%    0.03% 100.00%
  { 65536,    2,    2},  // 14     1  0.07%    0.03% 100.00%
  {131072,    4,    2},  // 15     1  0.04%    0.03% 100.00%
...
//  bytes pages batch   class  objs |fixed sampling|    inc
  {     0,    0,    0},  //  0     0  0.00%    0.00%   0.00%
  {     8,    1,   32},  //  1   512  1.16%    0.92%   0.00%
  {    16,    1,   32},  //  2   256  1.16%    0.92% 100.00%
  {    32,    1,   32},  //  3   128  1.16%    0.92% 100.00%
  {    64,    1,   32},  //  4    64  1.16%    0.92% 100.00%
  {   128,    1,   32},  //  5    32  1.16%    0.92% 100.00%
  {   256,    1,   32},  //  6    16  1.16%    0.92% 100.00%
  {   512,    1,   32},  //  7     8  1.16%    0.92% 100.00%
  {  1024,    2,   32},  //  8     8  0.58%    0.92% 100.00%
  {  2048,    4,   32},  //  9     8  0.29%    0.92% 100.00%
  {  4096,    4,   16},  // 10     4  0.29%    0.92% 100.00%
  {  8192,    4,    8},  // 11     2  0.29%    1.70% 100.00%
};
#else
