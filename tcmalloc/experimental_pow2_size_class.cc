...
//  bytes pages batch   class  objs |fixed sampling|    inc
  {     0,    0,    0},  //  0     0  0.00%    0.00%   0.00%
  {     8,    1,   32},  //  1   512  1.54%    0.92%   0.00%
  {    16,    1,   32},  //  2   256  1.54%    0.92% 100.00%
  {    32,    1,   32},  //  3   128  1.54%    0.92% 100.00%
  {    64,    1,   32},  //  4    64  1.54%    0.92% 100.00%
  {   128,    1,   32},  //  5    32  1.54%    0.92% 100.00%
  {   256,    1,   32},  //  6    16  1.54%    0.92% 100.00%
