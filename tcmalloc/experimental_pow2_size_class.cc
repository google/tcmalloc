...
//  bytes pages batch   class  objs |fixed sampling|    inc
  ...
  {  2048,    1,   32},  //  9     4  0.78%    0.42% 100.00%
...
//  bytes pages batch   class  objs |fixed sampling|    inc
  ...
  {131072,    1,    2},  // 15     2  0.02%   12.54% 100.00%
...
//  bytes pages batch   class  objs |fixed sampling|    inc
  {     0,    0,    0},  //  0     0  0.00%    0.00%   0.00%
  {     8,    1,   32},  //  1   512  1.54%    0.23%   0.00%
  {    16,    1,   32},  //  2   256  1.54%    0.23% 100.00%
  {    32,    1,   32},  //  3   128  1.54%    0.23% 100.00%
  {    64,    1,   32},  //  4    64  1.54%    0.23% 100.00%
  {   128,    1,   32},  //  5    32  1.54%    0.23% 100.00%
  {   256,    1,   32},  //  6    16  1.54%    0.23% 100.00%
  {   512,    1,   32},  //  7     8  1.54%    0.23% 100.00%
  {  1024,    2,   32},  //  8     8  0.78%    0.23% 100.00%
  {  2048,    4,   32},  //  9     8  0.39%    0.23% 100.00%
  {  4096,    4,   16},  // 10     4  0.39%    0.23% 100.00%
  {  8192,    4,    8},  // 11     2  0.39%    0.43% 100.00%
};
#else
