...
//  bytes  span_bytes batch    class      objs | fixed   sampling |    inc
  ...
  {   256,       8192,   32},  //  6        32   0.78%      0.42%  100.00%
  {   512,       8192,   32},  //  7        16   0.78%      0.42%  100.00%
  {  1024,       8192,   32},  //  8         8   0.78%      0.42%  100.00%
  {  2048,       8192,   32},  //  9         4   0.78%      0.42%  100.00%
  {  4096,       8192,   16},  // 10         2   0.78%      0.43%  100.00%
...
//  bytes  span_bytes batch    class      objs | fixed   sampling |    inc
  ...
  {   128,      32768,   32},  //  5       256   0.19%      1.60%  100.00%
  {   256,      32768,   32},  //  6       128   0.19%      1.60%  100.00%
  {   512,      32768,   32},  //  7        64   0.19%      1.60%  100.00%
  {  1024,      32768,   32},  //  8        32   0.19%      1.60%  100.00%
  {  2048,      32768,   32},  //  9        16   0.19%      1.60%  100.00%
  {  4096,      32768,   16},  // 10         8   0.19%      1.60%  100.00%
  {  8192,      32768,    8},  // 11         4   0.19%      1.60%  100.00%
  { 16384,      32768,    4},  // 12         2   0.19%      1.60%  100.00%
  { 32768,      32768,    2},  // 13         1   0.19%      0.03%  100.00%
  { 65536,      65536,    2},  // 14         1   0.10%      0.03%  100.00%
  {131072,     131072,    2},  // 15         1   0.05%      0.03%  100.00%
  {262144,     262144,    2},  // 16         1   0.02%      0.03%  100.00%
...
//  bytes  span_bytes batch    class      objs | fixed   sampling |    inc
  ...
  {   256,     262144,   32},  //  6      1024   0.02%     12.53%  100.00%
  {   512,     262144,   32},  //  7       512   0.02%     12.53%  100.00%
  {  1024,     262144,   32},  //  8       256   0.02%     12.53%  100.00%
  {  2048,     262144,   32},  //  9       128   0.02%     12.53%  100.00%
  {  4096,     262144,   16},  // 10        64   0.02%     12.53%  100.00%
  {  8192,     262144,    8},  // 11        32   0.02%     12.53%  100.00%
...
//  bytes  span_bytes batch    class      objs | fixed   sampling |    inc
  ...
  {   128,       4096,   32},  //  5        32   1.54%      0.23%  100.00%
  {   256,       4096,   32},  //  6        16   1.54%      0.23%  100.00%
  {   512,       4096,   32},  //  7         8   1.54%      0.23%  100.00%
  {  1024,       8192,   32},  //  8         8   0.78%      0.23%  100.00%
  {  2048,      16384,   32},  //  9         8   0.39%      0.23%  100.00%
  {  4096,      16384,   16},  // 10         4   0.39%      0.23%  100.00%
  {  8192,      16384,    8},  // 11         2   0.39%      0.43%  100.00%
};
#else
