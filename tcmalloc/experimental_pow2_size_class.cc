...
//  bytes pages batch   cap    class  objs  waste     inc
  ...
  {     8,    1,   32, 4712},  //  0  1024  0.59%   0.00%
  {    16,    1,   32, 4712},  //  1   512  0.59% 100.00%
  {    32,    1,   32, 4713},  //  2   256  0.59% 100.00%
  {    64,    1,   32, 4712},  //  3   128  0.59% 100.00%
  {   128,    1,   32, 4712},  //  4    64  0.59% 100.00%
  {   256,    1,   32, 2427},  //  5    32  0.59% 100.00%
  {   512,    1,   32, 1337},  //  6    16  0.59% 100.00%
  {  1024,    1,   32,  789},  //  7     8  0.59% 100.00%
  {  2048,    2,   32,  513},  //  8     8  0.29% 100.00%
  {  4096,    1,   16,  529},  //  9     2  0.59% 100.00%
  {  8192,    1,    8,  384},  // 10     1  0.59% 100.00%
...
//  bytes pages batch   cap    class  objs  waste     inc
  {     0,    0,    0,    0},  //  0     0  0.00%   0.00%
  {     8,    1,   32, 4840},  //  0   512  1.17%   0.00%
  {    16,    1,   32, 4840},  //  1   256  1.17% 100.00%
  {    32,    1,   32, 4840},  //  2   128  1.17% 100.00%
  {    64,    1,   32, 4840},  //  3    64  1.17% 100.00%
  {   128,    1,   32, 4840},  //  4    32  1.17% 100.00%
  {   256,    1,   32, 4050},  //  5    16  1.17% 100.00%
  {   512,    1,   32, 1491},  //  6     8  1.17% 100.00%
  {  1024,    2,   32, 1425},  //  7     8  0.59% 100.00%
