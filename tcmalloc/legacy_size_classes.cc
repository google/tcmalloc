...
static constexpr SizeClassInfo kLegacySizeClassesList[kCount] = {
    ...
    {    81920,      10,       2,        152},  // 0.06%
    {    98304,      12,       2,        152},  // 0.05%
    {   114688,      14,       2,        152},  // 0.04%
    {   131072,      16,       2,        152},  // 0.04%
    {   139264,      17,       2,        152},  // 0.03%
    {   155648,      19,       2,        152},  // 0.03%
    {   172032,      21,       2,        152},  // 0.03%
    {   204800,      25,       2,        152},  // 0.02%
    {   229376,      28,       2,        152},  // 0.02%
...
static constexpr SizeClassInfo kLegacySizeClassesList[kCount] = {
    ...
    {    90112,      11,       2,        152},  // 0.05%
    {    98304,      12,       2,        152},  // 0.05%
    {   106496,      13,       2,        152},  // 0.05%
    {   114688,      14,       2,        152},  // 0.04%
    {   131072,      16,       2,        152},  // 0.04%
    {   139264,      17,       2,        152},  // 0.03%
    {   147456,      18,       2,        152},  // 0.03%
    {   155648,      19,       2,        152},  // 0.03%
    {   172032,      21,       2,        152},  // 0.03%
    {   188416,      23,       2,        152},  // 0.03%
    {   204800,      25,       2,        152},  // 0.02%
    {   221184,      27,       2,        152},  // 0.02%
    {   237568,      29,       2,        152},  // 0.02%
    {   262144,      32,       2,        152},  // 0.02%
};
constexpr absl::Span<const SizeClassInfo> kLegacySizeClasses(kLegacySizeClassesList);
#elif TCMALLOC_PAGE_SHIFT == 15
