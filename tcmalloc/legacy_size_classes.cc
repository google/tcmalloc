...
//  bytes pages batch   class  objs |fixed sampling|    inc
  ...
  {   896,    1,   32},  // 41     9  2.33%    0.42%  16.67%
  {  1024,    1,   32},  // 42     8  0.78%    0.42%  14.29%
  {  1152,    2,   32},  // 43    14  1.95%    0.42%  12.50%
...
//  bytes pages batch   class  objs |fixed sampling|    inc
  ...
  {  7680,    1,    8},  // 59    34  0.41%   12.53%   9.09%
...
//  bytes pages batch   class  objs |fixed sampling|    inc
  ...
  {   120,    1,   32},  // 14    34  1.92%    0.91%  15.38%
  {   128,    1,   32},  // 15    32  1.54%    0.91%   6.67%
  {   136,    1,   32},  // 16    30  1.92%    0.91%   6.25%
  {   144,    1,   32},  // 17    28  3.08%    0.91%   5.88%
  {   160,    1,   32},  // 18    25  3.85%    0.92%  11.11%
  {   176,    1,   32},  // 19    23  2.69%    0.91%  10.00%
  {   192,    1,   32},  // 20    21  3.08%    0.92%   9.09%
  {   208,    1,   32},  // 21    19  5.00%    0.92%   8.33%
  {   240,    1,   32},  // 22    17  1.92%    0.91%  15.38%
  ...
  {  2688,    4,   24},  // 39     6  1.95%    0.92%  16.67%
...
//  bytes pages batch   class  objs |fixed sampling|    inc
  ...
  {  3200,    1,   20},  // 45    81  1.15%   12.53%  13.64%
  ...
  {  4736,    1,   13},  // 51    55  0.66%   12.53%   5.71%
  ...
  {  7680,    1,    8},  // 57    34  0.41%   12.53%   9.09%
...
//  bytes pages batch   class  objs |fixed sampling|    inc
  ...
  {  2688,    4,   24},  // 38     6  1.95%    0.92%  16.67%
