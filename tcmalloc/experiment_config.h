...
enum class Experiment : int {
  ...
  TEST_ONLY_TCMALLOC_CONFIGURE_SIZE_CLASS_MAX_CAPACITY,
...
inline constexpr ExperimentConfig experiments[] = {
    ...
    {Experiment::TEST_ONLY_TCMALLOC_CONFIGURE_SIZE_CLASS_MAX_CAPACITY, "TEST_ONLY_TCMALLOC_CONFIGURE_SIZE_CLASS_MAX_CAPACITY"},
