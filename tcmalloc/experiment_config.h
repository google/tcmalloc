...
enum class Experiment : int {
  ...
  TCMALLOC_FEW_OBJECT_SPAN_PRIORITIZATION,
  TEST_ONLY_TCMALLOC_USE_EXTENDED_SIZE_CLASS_FOR_COLD,
  TCMALLOC_SHORT_LONG_TERM_SUBRELEASE_V2,
  TEST_ONLY_TCMALLOC_LOWFRAG_SIZECLASSES,
  kMaxExperimentID,
};
...
inline constexpr ExperimentConfig experiments[] = {
    ...
    {Experiment::TCMALLOC_SHORT_LONG_TERM_SUBRELEASE_V2, "TCMALLOC_SHORT_LONG_TERM_SUBRELEASE_V2"},
