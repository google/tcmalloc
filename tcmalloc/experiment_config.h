...
enum class Experiment : int {
  ...
  TCMALLOC_USE_HUGE_REGIONS_MORE_OFTEN_V2,
  TCMALLOC_RELEASE_PARTIAL_ALLOC_PAGES,
  kMaxExperimentID,
};
...
inline constexpr ExperimentConfig experiments[] = {
    ...
    {Experiment::TCMALLOC_USE_HUGE_REGIONS_MORE_OFTEN_V2, "TCMALLOC_USE_HUGE_REGIONS_MORE_OFTEN_V2"},
    {Experiment::TCMALLOC_RELEASE_PARTIAL_ALLOC_PAGES, "TCMALLOC_RELEASE_PARTIAL_ALLOC_PAGES"},
};
// clang-format on
