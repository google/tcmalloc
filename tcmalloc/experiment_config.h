...
enum class Experiment : int {
  ...
  TEST_ONLY_TCMALLOC_REDUCED_BELOW64_SIZECLASS,
...
inline constexpr ExperimentConfig experiments[] = {
    ...
    {Experiment::TEST_ONLY_TCMALLOC_REDUCED_BELOW64_SIZECLASS, "TEST_ONLY_TCMALLOC_REDUCED_BELOW64_SIZECLASS"},
    ...
    {Experiment::TCMALLOC_PRIORITIZE_SPANS, "TCMALLOC_PRIORITIZE_SPANS"},
};
// clang-format on
